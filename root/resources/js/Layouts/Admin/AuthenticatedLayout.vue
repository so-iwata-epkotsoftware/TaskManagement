            ...
            >
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('admin.tasks.create')" :active="route().current('admin.tasks.create')" >
                                    タスク作成
                                </NavLink>
                ...
                >
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink :href="route('admin.tasks.create')" :active="route().current('admin.tasks.create')">
                            タスク作成
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('admin.tasks.create')" :active="route().current('admin.tasks.create')">
                            タスク担当者一覧
