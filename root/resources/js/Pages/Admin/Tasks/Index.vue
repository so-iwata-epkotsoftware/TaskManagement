...
import ShowTask from '@/Components/Admin/ShowTask.vue';
                    ...
                    <div class="text-gray-900">
                        <section class="text-gray-600 body-font w-full">
                            ...
                            <Modal :show="modalVisible" @close="modalVisible = false">
                                <ShowTask :taskData="taskData" :userName="userData.name" @close="modalVisible = false" :errors="errors"/>
                            </Modal>
                                            ...
                                            <table class="table-auto text-left whitespace-no-wrap border-collapse w-full">
                                                ...
                                                <tbody>
                                                    <tr v-for="task in user.tasks" :key="task.id" @click="showTask(task, user.name)"
                                                        ...
                                                        <td class="p-3 text-center">{{ task.priority_jp }}</td>
                                                        <td class="p-3 text-center">{{ task.status_jp }}</td>
